...
trait HelperTrait
{
    ...
    public function notifySessionStudents($sid,$subject,$message,$sms=true,$customSms=null){
        $sessionTable = new \App\Models\SessionTable($this->getServiceLocator());
        $studentSessionTable = new \App\Models\StudentSessionTable($this->getServiceLocator());
    ...
    public function notifyAdmins($subject,$message,$sm=null){
        ...
        $accountsTable= new \App\Models\AccountsTable();
    ...
    public function notifyStudent($id,$subject,$message){
        try{
            ...
            $accountsTable= new \App\Models\StudentTable();
    ...
    public function notifyStudentSms($id,$message){
        ...
        $accountsTable= new \App\Models\StudentTable($this->getServiceLocator());
    ...
    public function addPayment($amount,$studentId,$paymentMethodId){
        ...
        $table = new \App\Models\PaymentTable($this->getServiceLocator());
    ...
    public function hasPermission($path){
        $permissionTable = new \App\Models\PermissionTable($this->getServiceLocator());
