       ...
       @php elseif($row->type=='file'):  @endphp
        ...
        <div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <tbody>
                @php foreach(\App\Models\Student::find($id)->studentCourses as $session): @endphp
                    <tr>
                        <td>{{$session->course->name}}</td>
                        <td>@php $attended= $attendanceTable->getTotalDistinctForStudentInSession($id,$session->course_id); echo $attended @endphp/{{ \App\Models\Course::find($session->course_id)->lessons()->count() }}</td>
