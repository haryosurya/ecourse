                ...
                <div class="tab-pane fade" id="logo"> 
                    <div class="form-group col-sm-6" style="margin-bottom:10px"> 
                        ...
                        <div class="image"><img data-name="image" src="{{ $logo }}" alt="" id="thumb_logo" /><br />
                            ...
                            <a class="pointer" onclick="image_upload('image_logo', 'thumb_logo');">{{__lang('browse')}}</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a class="pointer" onclick="$('#thumb_logo').attr('src', '{{ $no_image }}'); $('#image_logo').attr('value', '');">{{__lang('clear')}}</a>
                        </div> 
                    </div>
                    ...
                    <div class="form-group col-sm-6" style="margin-bottom:10px"> 
                        ...
                        <div class="image"><img data-name="image" src="{{ $icon }}" alt="" id="thumb_icon" /><br />
                            ...
                            <a class="pointer" onclick="image_upload('image_icon', 'thumb_icon');">{{__lang('browse')}}</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a class="pointer" onclick="$('#thumb_icon').attr('src', '{{ $no_image }}'); $('#image_icon').attr('value', '');">{{__lang('clear')}}</a>
                        </div> 
                    </div>
